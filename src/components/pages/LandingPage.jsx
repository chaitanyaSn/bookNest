      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-blue-400">BookNest</span>
          </h1>
          ...
          <div className="mt-10 flex justify-center gap-4">
            {user ? (
              <div className="space-x-4">
                <Link
                  to="/books"
                  className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-blue-400 to-cyan-400  transition-colors duration-200 cursor-pointer"
                >
                  Browse Books
                </Link>
                <Link
                  to="/sell"
                  className="inline-flex items-center px-6 py-3 border border-cyan-400 text-base font-medium rounded-md text-blue-400 hover:bg-purple-50 transition-colors duration-200"
                >
                  Sell a Book
                </Link>
              </div>
              ...
              <Link
                to="/login"
                className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-blue-400 to-cyan-400 hover:bg-blue-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
              >
                Get Started
              </Link>
            )}
        ...
        <div className="mt-32 bg-blue-100 rounded-md p-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg hover:bg-blue-50 transition-shadow duration-200">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-gradient-to-r from-blue-400 to-cyan-400 text-white mx-auto">
